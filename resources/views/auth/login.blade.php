...
<head>
  ...
  <title>Connexion - L'OPTICIEN CREATEUR</title>
  <meta name="description" content="Connectez-vous à votre compte L'OPTICIEN CREATEUR">
  <meta name="keywords" content="login, connexion, compte, optique">
            ...
            <div class="card auth-card">
              <div class="row g-0">
                  ...
                  <div class="card-body">
                    ...
                    <form class="needs-validation" action="/login" method="POST" novalidate>
                      ...
                      <div class="auth-footer">
                        <p>Vous n'avez pas de compte? <a href="register.html" class="text-decoration-none fw-bold">S'inscrire</a></p>
                        <div class="text-center mb-3">ou connectez-vous avec</div>
                ...
                <div class="col-lg-6 auth-image">
                  <img src="assets/img/login-image.svg" alt="Login" class="img-fluid" data-aos="zoom-in">
                </div>
              </div>
            </div>
          </div>
