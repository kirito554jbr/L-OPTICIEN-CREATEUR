...
<body>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addProductModal">
                                <i class="bi bi-plus-lg me-1"></i> Ajouter un Rendez-vous
                            </button>
                        </div>
                    </div>
                </div>
                                    ...
                                    @foreach ($rendezVous as $rendez)
                                        <tr>
                                            ...
                                            <td class="product-actions">
                                                ...
                                                <form action="/rendezVous/delete{{ $rendez->id }}" method="POST"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addProductModalLabel">Ajouter une Rendez-vous</h5>
                ...
                <form action="/rendezVous/create" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="email" id="productName" required>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Ajouter la Rendez-vous</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="editProductModal" tabindex="-1" aria-labelledby="editProductModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editProductModalLabel">Modifier la Rendez-vous</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
